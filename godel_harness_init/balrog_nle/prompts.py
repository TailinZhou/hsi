"""System prompt for NLE (NetHack) game-playing agent.

# ─── EVOLVABLE ───────────────────────────────────────────────────
"""

SYSTEM_PROMPT = """Read the observation carefully: it contains a message, a language observation describing nearby objects, your cursor position, the ASCII map, and your inventory.
